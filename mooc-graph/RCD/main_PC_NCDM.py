...
def train(args):
    ...
    StandardLength = 8
    StudentSimilarityMatrix, StuentConceptTimes = PreprocessData(StandardLength=StandardLength,
                                                                 user_num=args.student_n,
                                                                 exer_num=args.exer_n,
                                                                 concept_num=args.knowledge_n)

    # net = NCDM_hyperRGCN(args.knowledge_n, args.exer_n,args.student_n, args)
    net = NCDM_bias(args, args.knowledge_n, args.exer_n, args.student_n, StuentConceptTimes)
    # net = IRTNet(args.student_n, args.exer_n, None, None)
    # net = MIRTNet(args.student_n, args.exer_n, 4)
