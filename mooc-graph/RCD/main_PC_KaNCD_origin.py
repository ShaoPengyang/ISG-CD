...
def train(args):
    ...
    net = KaNCD(args, args.exer_n, args.student_n, args.knowledge_n, 'gmf', 64)
    # net = KaNCD_bias(args.exer_n, args.student_n, args.knowledge_n, 'gmf', 64)
    # net = ADAKaNCD(args, args.exer_n, args.student_n, args.knowledge_n, 'gmf', 64)
    net = net.to(device)
